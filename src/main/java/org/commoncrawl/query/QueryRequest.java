...
public class QueryRequest<DataType extends RPCStruct, KeyType extends WritableComparable, ValueType extends Writable>
	...
	public enum RunState {
		IDLE, RUNNING_REMOTE, RUNNING_LOCAL, RUNNING_CACHE, ERROR
	}

	private RunState _runState = RunState.IDLE;
	private RunState _lastRunningState = RunState.IDLE;

	public QueryRequest(Query<DataType, KeyType, ValueType> query, ClientQueryInfo ClientQueryInfo,
			QueryCompletionCallback<DataType, KeyType, ValueType> callback) {
		_querySource = query;
