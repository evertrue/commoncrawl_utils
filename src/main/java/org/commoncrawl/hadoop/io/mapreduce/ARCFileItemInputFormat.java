...
public class ARCFileItemInputFormat extends FileInputFormat<Text, ArcFileItem> {
	...
	@Override
	public RecordReader<Text, ArcFileItem> createRecordReader(final InputSplit split, TaskAttemptContext context)
		...
		return new RecordReader<Text, ArcFileItem>() {
			...
			public boolean nextKeyValue() throws IOException, InterruptedException {
				...
				if (reader.nextKeyValue()) {
					...
					ArcFileItemUtils.bytesWritableToArcFileItem(reader.getCurrentKey(), reader.getCurrentValue(),
							currentValue);
