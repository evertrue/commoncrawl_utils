...
public abstract class OptimizedKeyGeneratorAndComparator<KeyType extends Writable, ValueType extends Writable> {
	...
	public static final class OptimizedKey {
		 ...
		 * @throws IOException
		 */
		public int initFromKeyValuePair(byte[] keyBytes, int keyOffset, int keyLength, byte[] valueBytes,
			...
			if ((_keyType & KEY_TYPE_BUFFER) != 0 && _dataBufferSize != 0) {
				...
				_dataBuffer.set(valueBytes, valueOffset + valueLength - _dataBufferSize, _dataBufferSize, true);
			}
