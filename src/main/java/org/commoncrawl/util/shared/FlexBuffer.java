 ...
 * @author rana
 */
public final class FlexBuffer extends BinaryComparableWithOffset implements WritableComparable<BinaryComparable>,
		RawComparator<FlexBuffer>, RawComparable, Cloneable {
	...
	*/
	...
	public int compareTo(FlexBuffer other) {
		return BytesWritable.Comparator.compareBytes(this.zbytes, this.offset, this.count, other.zbytes, other.offset,
				other.count);
	}
