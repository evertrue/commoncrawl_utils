 ...
 *
 */
public abstract class BinaryComparableWithOffset extends BinaryComparable implements
	...
	public int compareTo(byte[] other, int off, int len) {
		return WritableComparator.compareBytes(getBytes(), getOffset(), getLength(), other, off, len);
	}
